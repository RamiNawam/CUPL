...
// Note: Removed Button import if it's unused, but keep if you plan to use it!
...
export default function AboutPage() {
  ...
  return (
      <div className={styles.page}>
        ...
        <Section className={styles.heroSection} style={{ position: 'relative', overflow: 'hidden' }}>
          ...
          <div
              style={{
                ...
                width: '100%',
                height: '100%',
                backgroundImage: "url('/images/DSC03639.jpeg')",
        ...
        {/* Section 1: What is CUPL? (Dark Background, Text Left, Image Right) */}
        <Section className={styles.sectionPrimary}>
          <div className={styles.wideContent}>
            ...
            <div className={styles.imageContent}>
              ...
              <img src="/images/aboutcupl_1.JPG" alt="Students playing padel" />
            </div>
          </div>
        </Section>

        {/* Section 2: Origin Story (Darker Background, Image Left, Text Right) */}
        <Section className={styles.sectionSecondary}>
          <div className={`${styles.wideContent} ${styles.reverseLayout}`}>
            <div className={styles.textContent}>
            ...
            <div className={styles.imageContent}>
              {/* Replace src with your actual image path */}
              <img src="/images/aboutcupl_3.JPG" alt="Founders of CUPL" />
            </div>
          </div>
        </Section>

        {/* Section 3: Our Mission (Dark Background, Text Left, Image Right) */}
        <Section className={styles.sectionPrimary}>
          <div className={styles.wideContent}>
            <div className={styles.textContent}>
              <h2>Our Mission</h2>
            ...
            <div className={styles.imageContent}>
              {/* Replace src with your actual image path */}
              <img src="/images/aboutcupl_2.JPG" alt="Padel tournament" />
            </div>
          </div>
        </Section>
